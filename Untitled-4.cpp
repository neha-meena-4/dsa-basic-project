...
Node* mergeBinomialTrees(Node *b1, Node *b2)
{
    ...
    //Making larger one Child of smaller tree
    b2->parent = b1;
    b2->sibling = b1->child;
    b1->child = b2;
    b1->degree++;
                               ...
                               list<Node*> l2)
{
    ...
    list<Node*> _new;//new binomial heap which contains both
                              ...
                              Node *tree)
{
    ...
    // union operation to  insert Binomial Tree in original heap
...
// removing minimum key element from binomial heap take Binomial Tree  and return binomial heap after
...
int main()
{
    ...
    _heap = insert(_heap,15);
    _heap = insert(_heap,20);
    _heap = insert(_heap,25);
